control 'SV-230449' do
  title 'Successful/unsuccessful uses of the truncate command in RHEL 8 must
...
auid!=unset -k perm_access
  ...
  tag satisfies: ['SRG-OS-000062-GPOS-00031', 'SRG-OS-000037-GPOS-00015', 'SRG-OS-000042-GPOS-00020', 'SRG-OS-000062-GPOS-00031', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000462-GPOS-00206', 'SRG-OS-000471-GPOS-00215', 'SRG-OS-000064-GPOS-00033']
  tag gid: 'V-230449'
  tag rid: 'SV-230449r627750_rule'
  tag stig_id: 'RHEL-08-030420'
  tag fix_id: 'F-33093r568094_fix'
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']

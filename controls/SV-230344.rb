...
after #{input('unsuccessful_atempts')} unsuccessful logon attempts within a period of 15 minutes with the
following commands:
...
after #{input('unsuccessful_atempts')} unsuccessful logon attempts occur in 15 minutes.

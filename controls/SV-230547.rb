...
additional attack vectors.'
  desc 'check', 'Verify RHEL 8 restricts exposed kernel pointer addresses access with the
following commands:
...
returned, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to restrict exposed kernel pointer addresses access by

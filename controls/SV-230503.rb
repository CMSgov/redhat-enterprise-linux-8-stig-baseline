...
facilitating malicious activity.'
  desc 'check', 'Verify the operating system disables the ability to load the USB Storage
kernel module.
...
is a finding.'
  desc 'fix', 'Configure the operating system to disable the ability to use the USB

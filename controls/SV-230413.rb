...
"unset" in the same way.'
  desc 'check', 'Verify if RHEL 8 is configured to audit the execution of the
...
this is a finding.'
  desc 'fix', 'Configure RHEL 8 to audit the execution of the "lremovexattr" system
...
perm_mod
  ...
  tag satisfies: ['SRG-OS-000062-GPOS-00031', 'SRG-OS-000037-GPOS-00015', 'SRG-OS-000042-GPOS-00020', 'SRG-OS-000062-GPOS-00031', 'SRG-OS-000392-GPOS-00172', 'SRG-OS-000458-GPOS-00203', 'SRG-OS-000462-GPOS-00206', 'SRG-OS-000463-GPOS-00207', 'SRG-OS-000468-GPOS-00212', 'SRG-OS-000471-GPOS-00215', 'SRG-OS-000474-GPOS-00219', 'SRG-OS-000466-GPOS-00210']
  tag gid: 'V-230413'
  tag rid: 'SV-230413r627750_rule'
  tag stig_id: 'RHEL-08-030200'
  tag fix_id: 'F-33057r567986_fix'
  tag cci: ['CCI-000169']
  tag nist: ['AU-12 a']

...
sudoers(5) manual page.)
  desc 'check', %q(Verify that the sudoers security policy is configured to use the invoking
...
/etc/sudoers.d/* | grep -v '#'
  ...
  desc 'fix', 'Define the following in the Defaults section of the /etc/sudoers file or a

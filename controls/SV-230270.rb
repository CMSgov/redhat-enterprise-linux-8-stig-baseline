...
attackers from gaining additional system information as a non-privileged user.'
  desc 'check', 'Verify the operating system is configured to prevent kernel profiling by
...
commented out, this is a finding.'
  desc 'fix', 'Configure the operating system to prevent kernel profiling by unprivileged
users.

...
https://www.usno.navy.mil/USNO/time/ntp/dod-customers for more information.'
  desc 'check', %q(Verify RHEL 8 disables the chrony daemon from acting as a server with the
following command:
...
this is a finding.)
  desc 'fix', 'Configure the operating system to disable the chrony daemon from acting as

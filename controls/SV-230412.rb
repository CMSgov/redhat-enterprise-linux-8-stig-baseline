...
\"unset\" in the same way.
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify RHEL 8 generates audit records when successful/unsuccessful attempts
...
is a finding.
  "
  desc 'fix', "
    Configure RHEL 8 to generate audit records when successful/unsuccessful
...
-k privileged-priv_change
  ...
  tag satisfies: %w(SRG-OS-000062-GPOS-00031 SRG-OS-000037-GPOS-00015
                    ...
                    SRG-OS-000064-GPOS-0003 SRG-OS-000392-GPOS-00172

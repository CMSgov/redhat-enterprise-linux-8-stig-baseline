...
control on symlinks.'
  desc %q(Discretionary Access Control (DAC) is based on the notion that
...
avoiding an exploitation vector exploiting unsafe use of open() or creat().)
  desc 'check', 'Verify the operating system is configured to enable DAC on symlinks with

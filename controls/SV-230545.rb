...
additional attack vectors.'
  desc 'check', 'Verify RHEL 8 prevents privilege escalation thru the kernel by disabling
...
returned, this is a finding.'
  desc 'fix', 'Configure RHEL 8 to prevent privilege escalation thru the kernel by
